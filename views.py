...
def profile_upload(request):
    ...
    if csv_file.name.endswith('.csv'):
        ...
        engine = create_engine('postgresql://postgres:Gangadri3@6@localhost:5432/matches_data')
        data_set.to_sql('ipl_game_gangster', engine, if_exists='replace')
...
def population_chart(request):
    ...
    queryset = Gangster.objects.values()[:5]
...
def maximum_player_match(request):
    ...
    queryset = Gangster.objects.values("player_of_match")
...
def toss_winner(request):
    ...
    queryset = Gangster.objects.values("toss_winner")
...
def winner(request):
    ...
    queryset = Gangster.objects.values("winner")
